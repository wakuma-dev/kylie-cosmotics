...
const Favorites = lazy(
  () => import("../pages/cosmetics/featured/Favorites.jsx"),
);
...
const BundlesSets = lazy(
  () => import("../pages/cosmetics/featured/BundlesSets.jsx"),
);
const Collections = lazy(
  () => import("../pages/cosmetics/featured/Collections.jsx"),
);
...
const LiquidLipstick = lazy(
  () => import("../pages/cosmetics/lip/LiquidLipstick.jsx"),
);
...
const TravelSized = lazy(
  () => import("../pages/cosmetics/new/TravelSized.jsx"),
);
